...
import { BookmarksOutlined, SearchOutlined, TimelineOutlined } from '@mui/icons-material';
  ...
  return (
    <React.Fragment>
      <Box component="article" pt={containerTopPadding}>
        ...
        >
          <FeatureChip text="Search by location and skill" icon={<SearchOutlined color="primary" />} />

          <FeatureChip text="Save your searches" icon={<BookmarksOutlined color="primary" />} />

          <FeatureChip text="Visualise searches" icon={<TimelineOutlined color="primary" />} />
        </Box>

        <Box component="article" maxWidth="md" mx="auto" p={containerPadding} pt={containerTopPadding}>
          <Typography variant="h4" fontWeight="700" pb={2}>
            Try it out for free!
          </Typography>
          <Typography>
            Simply select a location and one or more skills to see a count of jobs currently listed on{' '}
            <a href="https://www.reed.co.uk" target="_blank" rel="noopener noreferrer">
              Reed.co.uk
            </a>
          </Typography>
          <SearchForm />
